...
CREATE TABLE IF NOT EXISTS tasks (
  ...
  task_quarter TINYINT UNSIGNED NOT NULL,
  ...
  KEY idx_tasks_period (task_year, task_quarter, deleted_at),
  ...
  CONSTRAINT chk_tasks_year CHECK (task_year BETWEEN 2020 AND 2100),
  CONSTRAINT chk_tasks_quarter CHECK (task_quarter BETWEEN 1 AND 4),
